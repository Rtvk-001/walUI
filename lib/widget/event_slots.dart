...
class EventSlotsWidget extends StatefulWidget {
  final Map<String, dynamic> event;
  final Function(String) onSlotSelected;

  const EventSlotsWidget({required this.event, required this.onSlotSelected});

  @override
  _EventSlotsWidgetState createState() => _EventSlotsWidgetState();
}

class _EventSlotsWidgetState extends State<EventSlotsWidget> {
  String? selectedSlot;
