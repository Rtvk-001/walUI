                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 20), // Spacing between the image and the "Login" text
                      Text(
                        'Login',
                      ...
                      const SizedBox(height: 30), // Spacing between the "Login" text and the first TextFormField
                      Text(
                        ' Email',
                        style: GoogleFonts.poppins(
                          fontSize: 20,
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          labelStyle: GoogleFonts.poppins(
                            color: const Color(0xFFB0B7BF), // Color of the label text when not focused
                          ),
                      ...
                      const SizedBox(height: 30), // Spacing between the first and second TextFormField
                      Text(
                        ' Password',
                        style: GoogleFonts.poppins(
                          fontSize: 20,
